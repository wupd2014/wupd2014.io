...
namespace Com.Alipay
{
    ...
    public class AlipayTradeImpl : IAlipayTradeService
    {
     ...
     string sign_type, string alipay_public_key, string charset)
        ...
        #region 接口方法
        public AlipayF2FPayResult tradePay(AlipayTradePayContentBuilder builder,string token)
        {               
            ...
            try
            {
                ...
                AlipayTradePayResponse payResponse = client.Execute(payRequest,null,token);
        ...
        public AlipayF2FQueryResult tradeQuery(string outTradeNo,string token)
        {                
            ...
            try
            {
                ...
                result.response = client.Execute(payRequest,null,token);
                return result;
            }
            catch
            {
        ...
        {
            return tradeRefund(builder, null);
        }
        public AlipayF2FRefundResult tradeRefund(AlipayTradeRefundContentBuilder builder, string token)
        {               
            ...
            try
            {
                ...
                refundResult.response = client.Execute(refundRequest,null,token);
                return refundResult;
            }
            catch
            {
        ...
        {
            return tradePrecreate(builder, null, null);
        }
        public AlipayF2FPrecreateResult tradePrecreate(AlipayTradePrecreateContentBuilder builder,string session,string token)
        {               
            ...
            try
            {
                ...
                payRequest.BizContent = builder.BuildJson();
                payResult.response = client.Execute(payRequest,null,token);
                return payResult;
            }
            catch
            {
